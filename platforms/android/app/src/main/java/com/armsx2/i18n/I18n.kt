...
private val BASE_EN: Map<String, String> = mapOf(
    ...
    "friends.explain" to "Link Discord to show what you're playing and see which friends are in Black Ice. Uses your existing Discord friends — Black Ice keeps no account and runs no server. Only while the app is open.",
    ...
    "friends.playingNow" to "In Black Ice now",
    "friends.nobody" to "None of your Discord friends are in Black Ice right now.",
    "friends.notify" to "Notify me in game",
    "friends.notify.desc" to "Show a message over the game when a friend starts playing Black Ice.",
    ...
    "about.memory" to "Memory capacity",
    ...
    "about.pcsx2.description" to "Black Ice is powered by the open-source ARMSX2 and PCSX2 projects.",
    ...
    "update.checkOnLaunch.desc" to "Automatically check GitHub for a new version each time Black Ice starts.",
    ...
    "app.bootLogo.desc" to "Play the Black Ice intro video when the app starts.",
    ...
    "games.exit.message" to "Are you sure you want to close Black Ice?",
    "games.exit.title" to "Exit Black Ice?",
    ...
    "games.quickLoad.confirmBody" to "This copies the disc's files into Black Ice's internal storage so the game can load them directly.\n\nSpace needed: about %1\$s\nFree right now: %2\$s\n\nYou can remove them later by holding the entry it creates and choosing Remove quick-load files.",
    ...
    "hotkeys.exitToLauncher.description" to "When a game was launched from another app (e.g. ES-DE), Close Game returns to that app instead of the Black Ice library.",
    ...
    "memcard.delete.body" to "Remove \"%s\" from Black Ice?\n\nThis deletes the card that Black Ice keeps in its own memory-card folder. If you imported it from a file on your device, that original file is not touched.",
    ...
    "patches.bundled.header" to "Bundled with Black Ice",
    "patches.bundled.explain" to "These ship inside Black Ice and are applied to this game automatically — you didn't install them. Ones with no name are always on and can't be switched off individually.",
    ...
    "renderer.importTexturePack.bootFirst" to "Boot a game first so Black Ice knows the serial.",
    ...
    "setup.systemDir.intro" to "Black Ice stores memory cards, save states, configs, and shader data in app-private storage by default. ",
    ...
    "setup.welcome.heading" to "Welcome to Black Ice setup!",
    ...
    "osd.temps" to "Device temperatures (when available)",
